            ...
            <article class="single-page">
                <div class="breadcrumb">
                    <ul class="breadcrumb__ul">
                        <li class="breadcrumb__item"><a href="" class="breadcrumb__link" title="خانه">بخش مقالات</a>
                        </li>
                        <li class="breadcrumb__item"><a href="" class="breadcrumb__link"
                                                        title="فریم ورک لاراول چیست ؟‌">فریم
                                    ...
                                    <div class="comments__row">
                                        <div class="d-flex flex-grow-1">
                                            ...
                                            <div class="comments__details">
                                                <h5 class="comments__author"><span class="comments__author-name">محمد نیکو نیکو نیکو</span>
                                                </h5>
                                                    ...
                                                    <div class="d-flex flex-grow-1">
                                                        ...
                                                        <div class="comments__details">
                                                            <h5 class="comments__author"><span
                                                                    class="comments__author-name">محمد نیکو نیکو نیکو</span>
                                                            </h5>
                                                            <span class="comments_date"> 523 روز پیش </span>
                                                        </div>
                                                    </div>
